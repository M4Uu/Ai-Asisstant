    ...
    once: false,
     ...
     async execute(interaction, client){
        ...
        if(command){
            ...
            if(command.Cooldown && cooldown.has(interaction.user.id)) return interaction.reply({content:`Este comando tiene un tiempo de espera. Tienes que esperar ${cooldowns / 1000} segundos para volver a usarlo`, ephemeral:true})
